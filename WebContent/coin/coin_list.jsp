...
<body>
	<div class="modal fade" id="myModal" tabindex="-1">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">
						<b>코인구매<a id="buyCoin" data-toggle="popover"> <img alt="" src="coin/img/chat-dots.svg">
						</a></b>
					</h5>
				...
				<div class="modal-body">
					...
					<div class="input-group mb-3">
						<div class="btn-group">
							<button class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown" href="#">
								코인<span class="caret"></span>
							</button>
						...
						<input type="text" style="text-align: center;" name="coinname" id='coinname' placeholder="코인을 선택해주세요" class="form-control" aria-label="Text input with dropdown button" readonly="readonly"> <input type="hidden" value="0" name="priceinput" id="priceinput"> <input type="hidden" value="0" name="sellpriceinput" id="sellpriceinput"> <input type="hidden" value="0" id="Apriceinput"> <input type="hidden" value="0" id="Bpriceinput"> <input type="hidden" value="0" id="Cpriceinput"> <input type="hidden" value="0" id="Dpriceinput"> <a id="closemodalbutton1"><img alt="" src="coin/img/x.svg" width="30" height="30"></a>
					</div>
					...
					<div class="modal-body">
						...
						<div class="input-group mb-3">
							...
							<input type="text" style="text-align: center;" name="coinname" id='coinname' placeholder="코인을 선택해주세요" class="form-control" aria-label="Text input with dropdown button" readonly="readonly"> <input type="hidden" value="0" name="priceinput" id="priceinput"> <input type="hidden" value="0" name="sellpriceinput" id="sellpriceinput"> <input type="hidden" value="0" id="Asellpriceinput"> <input type="hidden" value="0" id="Bsellpriceinput"> <input type="hidden" value="0" id="Csellpriceinput"> <input type="hidden" value="0" id="Dsellpriceinput"> <input type="hidden" value="0" id="Apriceinput"> <input type="hidden" value="0" id="Bpriceinput"> <input type="hidden" value="0" id="Cpriceinput"> <input type="hidden" value="0" id="Dpriceinput">
						...
						<div class="col-auto" style="padding-bottom: 15px;" align="center">
							<span id="passwordHelpInline" class="form-text" style="color: red;"> </span>
						</div>

						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" id="closemodalbutton2">닫기</button>
							<button id="modalbutton2" data-bs-toggle="modal" data-bs-target="#myModal2" type="button" class="btn btn-primary">
								바로구매<img alt="" src="coin/img/cart-check.svg" width="20" height="25">
							</button>
						</div>
					</div>
				</div>
		...
		<div class="modal fade" data-backdrop="static" data-keyboard="false" id="myModal2" tabindex="-1">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<label for="floatingInputValue"><b>구입한 코인</b></label> <input type="hidden" id="prmoney" value=0>
						<div id="rrr2"></div>
						<label for="floatingInputValue" style="padding-top: 10px;"><b>판매할 코인</b></label> <input type="text" style="text-align: center;" class="form-control" id="floatingInputValue" placeholder="name@example.com" value="" readonly="readonly">
						<div class="input-group mb-3">
							<div class="row g-3 align-items-center">
								<div class="col-auto">
		...
		<div id="myCarousel" class="carousel slide carousel-fade" data-ride='carousel' data-interval='3000' data-pause="hover">
			...
			<a class="carousel-control-prev" href="#myCarousel" role="button" data-slide="prev"> <span class="carousel-control-prev-icon" aria-hidden="true"></span> <span class="visually-hidden"></span></a> <a class="carousel-control-next" href="#myCarousel" role="button" data-slide="next"> <span class="carousel-control-next-icon" aria-hidden="true"></span> <span class="visually-hidden"></span></a>
		</div>
		<div style="display: inline-flex;">
			...
			<div>
				<pre>
        <b>A COIN         B COIN         C COIN         D COIN</b>
      </pre>
				<pre>
        <span id="asd"></span>         <span id="bsd">          </span>          <span id="csd"></span>         <span id="dsd"></span>
      </pre>
			</div>
			<div class="ml-5">
				<c:if test="${empty id}">
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#loginModalForm">로그인후 구매</button>
				</c:if>
				<c:if test="${!empty id}">
					<button id="modalbutton" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">구매하기</button>
				</c:if>
			</div>
		</div>
		<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>
