...
<script>
	...
	function inputCheckSpecial() {
		...
		if (frm.id.value != "") {
			$.ajax({
				url : "http://localhost:8089/CoinTraderWebGame/UserIdCheck?id="
						+ frm.id.value,
				method : "GET",
				dataType : "JSON",
		...
		if (frm.email.value != ""
			...
			$.ajax({
				url : "http://localhost:8089/CoinTraderWebGame/UserEmailCheck?email="
						+ frm.email.value
						+ "&emailSelect="
						+ frm.emailSelect.value,
				method : "GET",
				dataType : "JSON",
				success : function(data) {
					if (data) {
...
<body>
	...
	<form name="frm" method="post" action="user?cmd=sign_up_pro">
		<div class="row g-3">
			...
			<div class="col-12">
				<br> <label for="pw1" class="form-label">비밀번호</label>
				<div class="input-group">
			...
			<div class="col-12">
				<br> <label for="re_pw" class="form-label">비밀번호 확인</label>
				<div class="input-group">
